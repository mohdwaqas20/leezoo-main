        ...
        <div style={{ flex: 1, padding: isMobile ? '1.5rem' : '2.5rem 2.5rem 2.5rem 2rem', display: 'flex', flexDirection: 'column', gap: '1.4rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', marginTop: 'auto', paddingTop: '0.5rem' }}>
            ...
            <button onClick={handleBuyWA}
              style={{ width: '100%', padding: '0.9rem', background: 'transparent', color: 'var(--dark)', border: '1.5px solid var(--border)', cursor: 'pointer', fontFamily: 'Jost,sans-serif', fontSize: '0.62rem', letterSpacing: '0.22em', textTransform: 'uppercase', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.5rem', transition: 'background 0.25s, border-color 0.25s' }}
